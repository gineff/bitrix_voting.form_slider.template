...
$this->addExternalJS("/local/components/gineff/voting.form/templates/with_slider/slider.js");
$this->addExternalCSS("/local/components/gineff/voting.form/templates/with_slider/slider.css");
?>
      ...
      <?foreach ($arResult["QUESTIONS"] as $arQuestion):?>
        <div class="slide"> 
          ...
          <?if ($arQuestion === end($arResult["QUESTIONS"])):?>
            <div class="btn btn-primary btn-sm finish-vote">Завершить</div>  
          <?endif?>
        </div>  
      <?endforeach?>
    </div>  
...
<div id="hideBlock" style="display:none;">
   <h5>Опрос пройден</h5>
   <a href="/vote_result.php?VOTE_ID=3" class="btn btn-primary btn-sm">Посмотреть результаты</a>
</div>
